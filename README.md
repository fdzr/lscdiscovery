...
Annotated development and test data with sampled uses, clusterings, change scores, visualizations, and more stats are available [here](https://zenodo.org/record/6433203#.YlKw_bkpBE4) and [here](https://zenodo.org/record/6433398#.YlKxy7kpBE4) respectively.
...
1. You can download the uses of the development set from [here](https://github.com/fdzr/lscdiscovery/files/8325500/uses_development_set.zip).
2. You can download the uses of the evaluation set from [here](https://github.com/fdzr/lscdiscovery/files/8325509/uses_evaluation_set.zip).
...
- Evaluation Phase 2 (Binary Detection): The [target words](https://github.com/fdzr/lscdiscovery/files/8299328/target_words_evaluation_phase2.txt) correspond to the 60 hidden words from Phase 1. Participants get access to the annotated usages (20+20 from each corpus). Uploaded submissions will be scored against the 60 target words. The evaluation script for phase 2 ignores additional words other than the target words as input in phase 2.
